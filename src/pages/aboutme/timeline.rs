    ...
    html! {
        <div class="relative pl-16 lg:pl-52 py-6 group" data-aos="fade-up">
            <a class="timeline_title">{&props.title}</a>
                <div class={format!("flex flex-col lg:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 lg:before:left-0 before:h-full before:px-px before:bg-nord4 dark:before:bg-nord3 before:ml-3.5 lg:before:ml-[11.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 lg:after:left-0 after:w-6 after:h-6 lg:after:w-4 lg:after:h-4 {} after:border-8 lg:after:border-4 after:box-content after:border-nord6 dark:after:border-nord5 after:rounded-full after:ml-3.5 lg:after:ml-[11.5rem] after:-translate-x-1/2 after:translate-y-0.5", props.color)}>
