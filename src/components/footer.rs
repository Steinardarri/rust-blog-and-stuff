...
pub fn Footer() -> Html {
    html! {
        <div id="footer" class="pb-52 lg:pb-6 bg-stone-300 dark:bg-stone-600">
            ...
            <p class="antialiased text-xl lg:text-md text-gray-700 dark:text-stone-200 text-center 
            font-lg lg:font-medium pt-4 lg:pt-0 px-20">{
              ...
              <a href="https://github.com/steinardarri/rust-blog-and-stuff" target="_blank" 
              class="italic lg:hover:font-bold">{"GitHub repository"}</a>
              {"."}
            </p>
        </div>
    }
